      ...
      <?php 
        ...
        foreach ($aFlights as $flight) {
          echo '<div class="card h-100">
                  ...
                  <div class="row-0">
                    <div class="col-lg-4 mb-4">'.$flight['origin_city'].'</div>
                    ...
                    <div class="row">
                      <div class="col-lg-6 mb-6 economy-class">
                          ...
                          <div class="row economy_selection">
                              <input type="checkbox" id="radio-1" class="radio" onclick="document.getElementById(\'radio-2\').checked = false"/><label class="class-type" for="radio-1"></label>
                          </div>
                      ...
                      <div class="col-lg-6 mb-6 business_class">
                        ...
                        <div class="row business_selection" id="business"> 
                            <input type="checkbox" id="radio-2" class="radio" onclick="document.getElementById(\'radio-1\').checked = false"/><label class="class-type" for="radio-2"></label>
                        </div>
                        <div class="row class-price">
                    ...
                    <div class="col-lg-12 mb-12" id="reservation-details">  
                        ...
                        <h1 class="header" data-userID="'.$iUser.'">Your Reservation</h1>
                          <div class="ticket-header">
                            <div class="ticket-departure">
                              <h1 class="city-abbr">'.$flight['from_airport_code'].'</h1><span class="city-name" id="flightOrigin">'.$flight['origin_city'].'</span>
                            </div>
                            ...
                            <div class="ticket-destination">
                              <h1 class="city-abbr">'.$flight['to_airport_code'].'</h1><span class="city-name" id="flightDestination" data-airportID="'.$flight['destination_city_id'].'">'.$flight['destination_city'].'</span>
                            </div>
                          </div>

                          <div class="ticket-header">
                            <div class="ticket-departure">
                              <h1 class="city-abbr">Departure</h1><span class="city-name">'.$flight['departure_time'].'</span>
                            </div>
          
                            <div class="ticket-destination">
                              <h1 class="city-abbr">Arrival</h1><span class="city-name">'.$flight['arrival_time'].'</span>
                            </div>
                          </div>
                          <div class="ticket-body">
                            <div class="row">
                              <div class="col item">
                                <h2 class="name">Passenger(s)</h2><span class="value passengers">'.$_SESSION['passengerCount'].'</span>
                              </div>
                            ...
                            <div class="row">
                              <div class="col item">
                                <h2 class="name reserved-date">Date</h2><span class="value" id="flightDate">'.$flight['departure_day'].'</span>
                              </div>
                            </div>
                      ...
                      <div class="col-lg-12 mb-12 ">
                          <div class="searchFlight">
                            <button class="btnReserveFlight btn-lightBlue ripple-effect" disabled>Reserve</button>
                          </div>
                      </div>
                    </div>
                  </div>';
